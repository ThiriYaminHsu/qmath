...
class Qubit(Qubits):
    """Wrapper around Qubits representing single qubit."""

    def __init__(self, q: Qubits):
        assert len(q) == 1, "This is expected to be a single qubit."
        super().__init__(q)
...
# Below are convenience gate definitions operating on single qubits.
